'''
    ...
    Solution:
        ...
        i = k // M, j = k % M
        For eg, for a 2D array of 3x4 elements (M=3, N=4), the corresponding 1D array is of size 12. Then the element at k=9 (10th element) of 1D array can be mapped to row = 9 // 4 = 2, col = 9 % 4 = 1.
        Thus, 9 -> (2,1)
